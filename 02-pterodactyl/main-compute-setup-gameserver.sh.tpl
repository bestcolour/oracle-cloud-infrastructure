...
BACKUP_RCLONE_REMOTE_PATH="${gameserver_rclone_remote_backup_path}"
...
sed -i "s/pterodactyl_backups/$BACKUP_RCLONE_REMOTE_PATH/g" /usr/local/bin/pterodactyl-backup
